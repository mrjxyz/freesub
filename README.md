...
> 🛡️ **本轮出库协议** (共 782 个): VLESS 451 · Shadowsocks 200 · Hysteria2 66 · VMESS 54 · Trojan 10 · AnyTLS 1
...
| :--- | :---: | :--- |
| 🚀 **Clash (YAML 格式)** | `782` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/clash.yaml) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/clash.yaml) |
| ⚡ **V2RayN (Base64 格式)** | `782` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/v2ray.txt) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/v2ray.txt) |
| 📦 **sing-box (JSON 格式)** | `782` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/singbox.json) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/singbox.json) |
