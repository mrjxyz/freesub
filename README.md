...
> 🛡️ **本轮出库协议** (共 793 个): VLESS 466 · Shadowsocks 191 · Hysteria2 63 · VMESS 56 · Trojan 17
...
| :--- | :---: | :--- |
| 🚀 **Clash (YAML 格式)** | `793` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/clash.yaml) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/clash.yaml) |
| ⚡ **V2RayN (Base64 格式)** | `793` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/v2ray.txt) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/v2ray.txt) |
| 📦 **sing-box (JSON 格式)** | `793` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/singbox.json) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/singbox.json) |
