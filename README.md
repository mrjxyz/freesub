...
> 🛡️ **本轮出库协议** (共 800 个): VLESS 422 · Shadowsocks 217 · Hysteria2 73 · VMESS 65 · Trojan 22 · AnyTLS 1
...
| :--- | :---: | :--- |
| 🚀 **Clash (YAML 格式)** | `800` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/clash.yaml) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/clash.yaml) |
| ⚡ **V2RayN (Base64 格式)** | `800` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/v2ray.txt) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/v2ray.txt) |
| 📦 **sing-box (JSON 格式)** | `800` | [CDN 直链](https://cdn.jsdelivr.net/gh/mrjxyz/freesub@output/singbox.json) · [Raw 直链](https://raw.githubusercontent.com/mrjxyz/freesub/output/singbox.json) |
...
> ℹ️ 本轮家宽池仅 4 个 —— 判定标准严格 (六重信号 + 欺诈分复核), 免费源里合格样本稀少, 数量少属正常, 不代表筛选失效。
